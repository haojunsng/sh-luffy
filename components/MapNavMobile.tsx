...
export default function MapNavMobile() {
  const [avatarPos, setAvatarPos] = useState({ x: 210, y: 560 })
  ...
  return (
    <div
      ref={containerRef}
      className="fixed inset-0 flex h-screen w-screen items-center justify-center overflow-hidden bg-black"
    ...
    >
      ...
      >
        <img
          ref={mapRef}
          src="/static/images/one-piece-map-mobile.svg"
          alt="One Piece Map Mobile"
